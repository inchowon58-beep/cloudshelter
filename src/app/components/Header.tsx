...
export default function Header() {
  ...
  return (
    <header className="sticky top-0 z-50 border-b border-[var(--line)] bg-[rgba(247,250,252,0.92)] backdrop-blur-md">
      <div className="trust-pulse flex items-center justify-center gap-2 bg-[var(--sky-deep)] px-3 py-2 text-center text-[0.78rem] font-semibold text-white md:text-sm">
        <span>안락사 없는 보호 · 파양입소 · 무료분양 상담 {SITE.phoneDisplay}</span>
      </div>
